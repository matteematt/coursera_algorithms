...
-- If one heap is two larger than the other then pop and add to the other
-- Calculate the median by the given formula

-- Sum the map and mod 10000 the value

data MedianTracker = MedianTracker Heap Heap [Int]

mainInts = map (read :: String -> Int) $ words mainData
